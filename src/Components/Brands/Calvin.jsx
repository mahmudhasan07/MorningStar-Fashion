...
const Calvin = () => {
    ...
    return (
        <section>
        <h1 className="text-5xl my-7 font-bold text-center underline"> Calvin Klein</h1>
        ...
        <div>
            <h1 className="text-4xl font-semibold text-center mt-10">Calvin Klein Products</h1>
        </div>
