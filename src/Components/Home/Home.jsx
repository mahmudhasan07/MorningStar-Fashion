...
const Home = () => {
    ...
    return (
        <section>
            <div data-aos="fade-down" className="lg:mx-8 mx-2 lg:my-10 my-5" >
                <Swiper
                    ...
                    navigation
                >
                    <SwiperSlide><img data-aos="zoom-in-up" className=" mx-auto rounded-lg h-[500px]" src='https://i.ibb.co/dKJXY48/Baner.jpg' alt="" /></SwiperSlide>
                    <SwiperSlide><img data-aos="zoom-in-up" className=" mx-auto rounded-lg h-[500px]" src="https://i.ibb.co/JKKcKWc/Baner2.jpg" alt="" /></SwiperSlide>
                    <SwiperSlide><img data-aos="zoom-in-up" className=" mx-auto rounded-lg h-[500px]" src="https://i.ibb.co/bQhHg3W/Baner3.jpg" alt="" /></SwiperSlide>
                    <SwiperSlide><img data-aos="zoom-in-up" className=" mx-auto rounded-lg h-[500px]" src="https://i.ibb.co/D7Bbj03/Baner4.jpg" alt="" /></SwiperSlide>
                </Swiper>
            </div>
            ...
            <div>
                ...
                <div data-aos="fade-up" className="flex flex-wrap gap-10 justify-center lg:my-10 my-5 lg:mx-10 mx-2">
